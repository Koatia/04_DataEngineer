...
class Book24Spider(scrapy.Spider):
    ...
    def parse(self, response: HtmlResponse):
        links = response.xpath(
            "//div[@class='product-list__item']//a[@class='product-card__image-link']/@href").getall()
        for link in links:
    ...
    def parse_book(self, response: HtmlResponse):
        ...
        #     "//picture[@class='product-poster__main-picture']/source[1]/@srcset | //picture[@class='product-poster__main-picture']/source[1]/@data-srcset").getall()

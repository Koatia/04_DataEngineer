/*
spark-shell -i /var/lib/mydir/d3.scala --conf "spark.driver.extraJavaOptions=-Dfile.encoding=utf-8" --packages mysql:mysql-connector-java:8.0.33,com.crealytics:spark-excel_2.12:3.5.1_0.20.4
*/
...
if (1 == 1) {
  ...
  val qq =
    """
		...
		"""
  var df3 = spark.read.format("jdbc")
    .option("url", "jdbc:mysql://mysql-db:3306/spark")
    .option("driver", "com.mysql.cj.jdbc.Driver")
    .option("user", "user")
    .option("password", "password")
